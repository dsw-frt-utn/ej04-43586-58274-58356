...
public class Persistencia {
    ...
    private static void inicializarVehiculos(){
       ...
       VehiculoElectrico v1 = new VehiculoElectrico("AE123FG", m1, "Kangoo E-Tech", 2020, 1000, s1, 16);
        ...
        VehiculoCombustible v3 = new VehiculoCombustible("AC789JK", m1, "Daily", 2023, 1200, s1, 8, 1.5);
        VehiculoCombustible v4 = new VehiculoCombustible("AD321LM",m2, "Sprinter", 2020, 1200, s2, 7, 1);
